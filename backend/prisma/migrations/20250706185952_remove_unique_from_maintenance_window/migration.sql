/*
  ...
  - You are about to drop the column `traitement_tine` on the `anomaly` table. All the data in the column will be lost.
...
INSERT INTO "new_anomaly" ("Criticite", "date_detection", "descreption_anomalie", "disponsibilite", "duree_intervention", "fiablite_integrite", "id", "maintenance_window_id", "num_equipments", "origine", "process_safty", "resolution_date", "section_proprietaire", "status", "systeme", "trained", "unite") SELECT "Criticite", "date_detection", "descreption_anomalie", "disponsibilite", "duree_intervention", "fiablite_integrite", "id", "maintenance_window_id", "num_equipments", "origine", "process_safty", "resolution_date", "section_proprietaire", "status", "systeme", "trained", "unite" FROM "anomaly";
DROP TABLE "anomaly";
